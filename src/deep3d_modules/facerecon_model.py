...
from deep3d_modules.util import util
from deep3d_modules.util.nvdiffrast import MeshRenderer
from deep3d_modules.util.preprocess import estimate_norm_torch
...
class FaceReconModel(BaseModel):
    ...
    def __init__(self):
        ...
        """
        BaseModel.__init__(self)  # call the initialization method of BaseModel
        ...
        net_recon = 'resnet50'
        use_last_fc = False
        init_path = '../external/Deep3DFaceRecon/checkpoints/init_model/resnet50-0676ba61.pth'
        bfm_folder = '../external/BFM'
        camera_d = 10
        focal = 1015.0
        center = 112.0
        ...
        self.net_recon = networks.define_net_recon(
            net_recon=net_recon, use_last_fc=use_last_fc, init_path=init_path
        )
